...
function () {
  function ShootingStar() {
    ...
    this.rate = 1;
    this.setSize();
    var folder = controller.addFolder('Marry Christmas!');
...
var $m6Ky$var$TEXT = 'Marry Christmas!';
var $m6Ky$var$FONT_SIZE = 45;
var $m6Ky$var$FONT_SIZE_SP = 38;
var $m6Ky$var$FONT_SIZE_MIN = 25;
var $m6Ky$var$LETTER_SPACING = 0.18;
var $m6Ky$var$LETTER_SPACING_SP = 0.1;
var $m6Ky$var$FONT = 'Times New Roman, serif';
var $m6Ky$var$COLOR = 'rgb(217, 13, 53)';
var $m6Ky$var$data = {
  visible: {
    value: true
  },
...
function () {
  function Text() {
    ...
    var fontSize =  $mrfc$export$default.clientWidth < 678 ? $m6Ky$var$FONT_SIZE_MIN : $mrfc$export$default.clientWidth < 700 ? $m6Ky$var$FONT_SIZE_SP :$m6Ky$var$FONT_SIZE;
    var letterSpacing = $mrfc$export$default.clientWidth < 678 ? $m6Ky$var$LETTER_SPACING_SP : $m6Ky$var$LETTER_SPACING;
